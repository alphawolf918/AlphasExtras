...
public class FarmingRegistry
{
	...
	public static void registerPlantable(IFactoryPlantable plantable)
	{
		try
		{
			Class<?> registry = Class
					.forName("powercrystals.minefactoryreloaded.MFRRegistry");
			if (registry != null)
			{
				Method reg = registry.getMethod("registerPlantable",
						IFactoryPlantable.class);
	...
	public static void registerHarvestable(IFactoryHarvestable harvestable)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerHarvestable",
						IFactoryHarvestable.class);
	 ...
	 */
	public static void registerFertilizable(
			IFactoryFertilizable fertilizable)
	{
		try
		{
			Class<?> registry = Class
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerFertilizable",
						IFactoryFertilizable.class);
	...
	public static void registerFertilizer(IFactoryFertilizer fertilizer)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerFertilizer",
						IFactoryFertilizer.class);
	...
	public static void registerRanchable(IFactoryRanchable ranchable)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerRanchable",
						IFactoryRanchable.class);
	...
	public static void registerGrindable(IFactoryGrindable grindable)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerGrindable",
						IFactoryGrindable.class);
	...
	public static void registerSludgeDrop(int weight, ItemStack drop)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerSludgeDrop",
	 ...
	 */
	public static void registerBreederFood(Class<?> entityToBreed,
			ItemStack food)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerBreederFood",
	...
	public static void registerSafariNetHandler(ISafariNetHandler handler)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod(
						"registerSafariNetHandler",
						ISafariNetHandler.class);
	...
	/**
	 * Registers a mob egg handler, which allows the Safari Net to properly
	 * change colors.
	 * 
	 * @param handler
	 *            The mob egg handler
	...
	public static void registerMobEggHandler(IMobEggHandler handler)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerMobEggHandler",
						IMobEggHandler.class);
				reg.invoke(registry, handler);
			}
		} catch (Exception e)
		{
	...
	public static void registerRubberTreeBiome(String biome)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerRubberTreeBiome",
						String.class);
	 ...
	 *            Class to blacklist
	 */
	public static void registerSafariNetBlacklist(
			Class<?> blacklistedEntity)
	{
		try
		{
			...
			{
				Method reg = registry.getMethod(
						"registerSafariNetBlacklist", Class.class);
	...
	/**
	 * Registers an entity as a possible output from villager random safari
	 * nets. Note that the "id" field must be initialized (i.e. with
	 * Entity.addEntityID()) for it to work correctly.
	 * 
	 * @param savedMob
	 *            A serialized mob that will be unloaded by the safari net
	 * @param weight
	 *            The weight of this mob in the random selection
	 */
	public static void registerVillagerTradeMob(
			IRandomMobProvider mobProvider)
	{
		try
		{
			Class<?> registry = Class
			...
			{
				Method reg = registry.getMethod(
						"registerVillagerTradeMob",
						IRandomMobProvider.class);
	 ...
	 */
	public static void registerLiquidDrinkHandler(int liquidId,
			ILiquidDrinkHandler liquidDrinkHandler)
	{
		try
		{
			Class<?> registry = Class
			...
			{
				Method reg = registry.getMethod(
						"registerLiquidDrinkHandler", int.class,
						ILiquidDrinkHandler.class);
	...
	public static void registerLaserOre(int weight, ItemStack drop)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerLaserOre",
						int.class, ItemStack.class);
				reg.invoke(registry, weight, drop);
			}
		} catch (Exception e)
	...
	public static void setLaserPreferredOre(int color, ItemStack ore)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("setLaserPreferredOre",
						int.class, ItemStack.class);
	...
	public static void registerFruitLogBlockId(Integer fruitLogBlockId)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerFruitLogBlockId",
						Integer.class);
	...
	public static void registerFruit(IFactoryFruit fruit)
	{
		try
		{
			...
			if (registry != null)
			{
				Method reg = registry.getMethod("registerFruit",
						IFactoryFruit.class);
	...
	public static void registerAutoSpawnerBlacklist(String entityString)
	{
		try
		{
			...
			{
				Method reg = registry.getMethod(
						"registerAutoSpawnerBlacklist", String.class);
	...
	public static void registerRedNetLogicCircuit(
			alphaitems.api.powercrystals.minefactoryreloaded.api.rednet.IRedNetLogicCircuit circuit)
	{
		try
		{
			Class<?> registry = Class
			...
			if (registry != null)
			{
				Method reg = registry
						.getMethod(
								"registerRedNetLogicCircuit",
								alphaitems.api.powercrystals.minefactoryreloaded.api.rednet.IRedNetLogicCircuit.class);
