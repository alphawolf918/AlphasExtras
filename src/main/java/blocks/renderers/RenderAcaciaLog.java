...
public class RenderAcaciaLog implements ISimpleBlockRenderingHandler {
	...
	public void renderInventoryBlock(Block block, int metadata,
		...
		var4.startDrawingQuads();
		var4.setNormal(0.0F, -1.0F, 0.0F);
		renderer.renderFaceYNeg(block, 0.0D, 0.0D, 0.0D, block.getIcon(0,
				metadata));
		var4.draw();
		...
		renderer.renderFaceZNeg(block, 0.0D, 0.0D, 0.1875D,
				block.getIcon(2, 0));
		var4.draw();
		
		var4.startDrawingQuads();
		var4.setNormal(0.0F, 0.0F, 1.0F);
		renderer.renderFaceZPos(block, 0.0D, 0.0D, -0.1875D,
				block.getIcon(3, 0));
		var4.draw();
		
		var4.startDrawingQuads();
		var4.setNormal(-1.0F, 0.0F, 0.0F);
		renderer.renderFaceXNeg(block, 0.1875D, 0.0D, 0.0D,
				block.getIcon(4, 0));
		var4.draw();
		
		var4.startDrawingQuads();
		var4.setNormal(1.0F, 0.0F, 0.0F);
		renderer.renderFaceXPos(block, -0.1875D, 0.0D, 0.0D,
				block.getIcon(5, 0));
		var4.draw();
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y,
		...
		switch (orientation)
		{
			case 4:
				...
				if (((AcaciaLog) Blocks.acaciaLog)
						.canConnect(world, x, y, z + 1))
			...
			case 8:
				...
				if (((AcaciaLog) Blocks.acaciaLog)
						.canConnect(world, x - 1, y, z))
					renderEastNub(x, y, z, block, renderer);
				if (((AcaciaLog) Blocks.acaciaLog)
						.canConnect(world, x + 1, y, z))
					renderWestNub(x, y, z, block, renderer);
				
				if (((AcaciaLog) Blocks.acaciaLog).canConnect(world, x,
						y + 1, z))
					renderUpNub(x, y, z, block, renderer);
				if (((AcaciaLog) Blocks.acaciaLog)
						.canConnect(world, x, y - 1, z))
	...
	private void renderNorthNub(int x, int y, int z, Block block,
			RenderBlocks renderer)
	{
		...
		// Set the render area
		renderer.setRenderBounds(0.1875D, 0.1875D, 0.8125D, 0.8125D,
				0.8125D, 1.0D);
	...
	private void renderSouthNub(int x, int y, int z, Block block,
			RenderBlocks renderer)
	{
		renderer.uvRotateEast = 0;
		renderer.uvRotateWest = 0;
		...
		// Set the render area
		renderer.setRenderBounds(0.1875D, 0.1875D, 0.0D, 0.8125D, 0.8125D,
				0.1875D);
	...
	private void renderEastNub(int x, int y, int z, Block block,
			RenderBlocks renderer)
	{
		...
		// Set the render area
		renderer.setRenderBounds(0.0D, 0.1875D, 0.1875D, 0.1875D, 0.8125D,
				0.8125D);
	...
	private void renderWestNub(int x, int y, int z, Block block,
			RenderBlocks renderer)
	{
		renderer.uvRotateEast = 1;
		renderer.uvRotateWest = 1;
		...
		// Set the render area
		renderer.setRenderBounds(0.8125D, 0.1875D, 0.1875D, 1.0D, 0.8125D,
				0.8125D);
	...
	private void renderUpNub(int x, int y, int z, Block block,
			RenderBlocks renderer)
	{
		renderer.uvRotateEast = 0;
		renderer.uvRotateWest = 0;
		...
		// Set the render area
		renderer.setRenderBounds(0.1875D, 0.8125D, 0.1875D, 0.8125D, 1.0D,
				0.8125D);
	...
	private void renderDownNub(int x, int y, int z, Block block,
			RenderBlocks renderer)
	{
		renderer.uvRotateEast = 0;
		renderer.uvRotateWest = 0;
		...
		// Set the render area
		renderer.setRenderBounds(0.1875D, 0.0D, 0.1875D, 0.8125D, 0.1875D,
				0.8125D);
	...
	private void renderUpDownCenter(int x, int y, int z, Block block,
			RenderBlocks renderer)
	{
		renderer.uvRotateEast = 0;
		renderer.uvRotateWest = 0;
		...
		// RenderBounds
		renderer.setRenderBounds(0.1875D, 0.0D, 0.1875D, 0.8125D, 1.0D,
				0.8125D);
	...
	private void renderNorthSouthCenter(int x, int y, int z, Block block,
			RenderBlocks renderer)
	{
	...
	private void renderEastWestCenter(int x, int y, int z, Block block,
			RenderBlocks renderer)
	{
		renderer.uvRotateEast = 1;
		renderer.uvRotateWest = 1;
		...
		// Set the render area
		renderer.setRenderBounds(0.0D, 0.1875D, 0.1875D, 1.0D, 0.8125D,
				0.8125D);
