...
public class AmaranthPickaxe extends ItemTool
{
	...
	public AmaranthPickaxe(int par1)
	{
		super(par1, 4.0F, EnumToolMaterial.EMERALD, blocksEffectiveAgainst);
		this.setCreativeTab(ModTabs.aiTab);
		this.setUnlocalizedName("pickaxeAmaranth");
		this.setMaxDamage(4000);
		this.setTextureName("awei:amaranthpickaxe");
