package alphaitems.lib.modhelper;
...
public class ThermalExpansionHelper {
	...
	public static void addSmelterBlastOre(String oreType) {
		...
		FMLInterModComms.sendMessage("ThermalExpansion",
				"SmelterBlastOreType", toSend);
	}
	
	public static void addTransposerExtract(int energy, ItemStack input,
			ItemStack output, FluidStack fluid, int chance,
			boolean reversible) {
	...
	public static void addReactantFuel(String fluidName, int energy) {
		...
		toSend.setString("fluidName", fluidName);
		toSend.setInteger("energy", energy);
		FMLInterModComms.sendMessage("ThermalExpansion", "ReactantFuel",
				toSend);
	}
	...
	public static void addCoolant(String fluidName, int energy) {
		...
		toSend.setInteger("energy", energy);
		FMLInterModComms
				.sendMessage("ThermalExpansion", "Coolant", toSend);
	}
	...
	public static void addPulverizerRecipe(int energy, ItemStack input,
		...
		addPulverizerRecipe(energy, input, primaryOutput, secondaryOutput,
				100);
	}
	...
	public static void addPulverizerRecipe(int energy, ItemStack input,
		...
		if (secondaryOutput != null) {
			secondaryOutput.writeToNBT(toSend
	...
	public static void addSawmillRecipe(int energy, ItemStack input,
			ItemStack primaryOutput, ItemStack secondaryOutput) {
		addSawmillRecipe(energy, input, primaryOutput, secondaryOutput,
				100);
	}
	...
	public static void addSmelterRecipe(int energy,
			ItemStack primaryInput, ItemStack secondaryInput,
			ItemStack primaryOutput) {
		addSmelterRecipe(energy, primaryInput, secondaryInput,
				primaryOutput, null, 0);
	}
	...
	public static void addSmelterRecipe(int energy,
			...
			ItemStack primaryOutput, ItemStack secondaryOutput) {
		addSmelterRecipe(energy, primaryInput, secondaryInput,
				primaryOutput, secondaryOutput, 100);
	}
