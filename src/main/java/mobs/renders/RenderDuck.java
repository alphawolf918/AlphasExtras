...
public class RenderDuck extends RenderLiving
{
	...
	public void renderDuck(EntityDuck par1EntityDuck,
			double par2, double par4, double par6, float par8, float par9)
	{
		super.doRenderLiving(par1EntityDuck, par2, par4, par6, par8,
				par9);
	}
	
	protected ResourceLocation getDuckTextures(
			EntityDuck par1EntityDuck)
	{
		return chickenTextures;
	}
	
	protected float getWingRotation(EntityDuck par1EntityDuck,
			float par2)
	{
	...
	{
		this.renderDuck((EntityDuck) par1EntityLiving, par2, par4,
				par6, par8, par9);
	}
	...
	{
		return this.getWingRotation((EntityDuck) par1EntityLivingBase,
				par2);
	}
	...
	public void renderPlayer(EntityLivingBase par1EntityLivingBase,
			double par2, double par4, double par6, float par8, float par9)
	{
		this.renderDuck((EntityDuck) par1EntityLivingBase, par2,
				par4, par6, par8, par9);
	}
	...
	{
		this.renderDuck((EntityDuck) par1Entity, par2, par4, par6,
				par8, par9);
	}
}