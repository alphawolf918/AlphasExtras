...
public class RenderScorpion extends RenderLiving {
	...
	protected void scaleScorpion(EntityScorpion par1EntityCaveSpider,
			float par2) {
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation("awei:textures/entity/scorpion.png");
	}
	
	public void renderTutorial(EntityScorpion entity, double par2,
	...
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		renderTutorial((EntityScorpion) par1EntityLiving, par2, par4,
				par6,
				par8, par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		renderTutorial((EntityScorpion) par1Entity, par2, par4, par6,
				par8,
				par9);
	}
}