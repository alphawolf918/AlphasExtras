...
public class RenderShadowSkeleton extends RenderLiving {
	...
	public RenderShadowSkeleton(ModelShadowSkeleton par1ModelBase,
			float par2) {
			...
			float par3)
	{
		...
		if (itemstack != null)
		{
			...
			{
				this.bindTexture(getArmorResource(par1EntityLiving,
						itemstack, par2, "overlay"));
				float f1 = 1.0F;
			...
			float par3)
	{
		...
		if (itemstack != null)
		{
			...
			if (item instanceof ItemArmor)
			{
				...
				modelbiped.bipedRightLeg.showModel = par2 == 2
						|| par2 == 3;
				modelbiped.bipedLeftLeg.showModel = par2 == 2 || par2 == 3;
				modelbiped = ForgeHooksClient.getArmorModel(
						par1EntityLiving, itemstack, par2, modelbiped);
			...
			else if (itemstack1.getItem().itemID == Item.skull.itemID)
			{
				...
				if (itemstack1.hasTagCompound()
						&& itemstack1.getTagCompound()
								.hasKey("SkullOwner"))
				{
					s = itemstack1.getTagCompound()
							.getString("SkullOwner");
				}
				
				TileEntitySkullRenderer.skullRenderer.func_82393_a(-0.5F,
						0.0F, -0.5F, 1, 180.0F,
						itemstack1.getItemDamage(), s);
			}
			...
			ItemStack stack, int slot, String type)
	{
		...
		String s1 = String.format(
				...
				bipedArmorFilenamePrefix[item.renderIndex], (slot == 2 ? 2
						: 1),
				type == null ? "" : String.format("_%s", type));
		
		s1 = ForgeHooksClient.getArmorTexture(entity, stack, s1, slot,
				type);
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation(
				"awei:textures/entity/shadowskeleton.png");
	}
	...
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		renderTutorial((EntityShadowSkeleton) par1EntityLiving, par2,
				par4,
				par6, par8, par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		renderTutorial((EntityShadowSkeleton) par1Entity, par2, par4,
				par6,
				par8, par9);
	}
	
	protected void scaleShadowSkeleton(
			EntityShadowSkeleton par1EntityShadowSkeleton,
			float par2) {
	...
	protected void preRenderCallback(
			...
			float par2) {
		this.scaleShadowSkeleton(
				(EntityShadowSkeleton) par1EntityLivingBase,
				par2);
	}
}