...
public class RenderShark extends RenderLiving {
	...
	public void renderTutorial(EntityShark entity, double par2,
			double par4,
			double par6, float par8, float par9) {
		super.doRenderLiving(entity, par2, par4, par6, par8, par9);
	}
	
	protected void scaleShark(EntityShark par1EntityCaveSpider,
			float par2) {
	...
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2,
		...
		renderTutorial((EntityShark) par1EntityLiving, par2, par4, par6,
				par8,
				par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
			double par6, float par8, float par9) {
		renderTutorial((EntityShark) par1Entity, par2, par4, par6, par8,
				par9);
	}
}