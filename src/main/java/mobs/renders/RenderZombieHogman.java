...
public class RenderZombieHogman extends RenderLiving {
	...
	public RenderZombieHogman(ModelHogZombie par1ModelBase, float par2) {
	...
	protected void func_130005_c(EntityLiving par1EntityLiving, float par2)
	{
		...
		if (itemstack != null)
		{
			...
			else if (itemstack.itemID == Item.swordGold.itemID)
			{
				f2 = 0.625F;
	...
	protected ResourceLocation getEntityTexture(Entity entity) {
		return new ResourceLocation(
				"awei:textures/entity/zombie_hogman.png");
	}
	...
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2,
			double par4, double par6, float par8, float par9) {
		renderTutorial((EntityHogZombie) par1EntityLiving, par2, par4,
				par6,
				par8, par9);
	}
	...
	public void doRender(Entity par1Entity, double par2, double par4,
		...
		renderTutorial((EntityHogZombie) par1Entity, par2, par4, par6,
				par8,
				par9);
	}
}