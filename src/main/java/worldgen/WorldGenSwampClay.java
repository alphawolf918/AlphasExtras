...
public class WorldGenSwampClay extends WorldGenerator
{
	...
	public WorldGenSwampClay(int par1, int par2)
	{
		this(par1, par2, Block.grass.blockID);
	}
	
	public WorldGenSwampClay(int par1, int par2, int par3)
	{
	...
	public WorldGenSwampClay(int id, int meta, int number, int target)
	{
